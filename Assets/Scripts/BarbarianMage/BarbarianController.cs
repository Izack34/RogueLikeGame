...
public class BarbarianController : EnemyController
{
    private BarbarianAnimation enemy_animator;

    private BarbarianSpells Spells;
    
    void Awake()
    { 
        enemy_animator = GetComponent<BarbarianAnimation>();
    ...
    public void UseWarstomp(){
        Spells.WarStomp(transform.position);
    }
